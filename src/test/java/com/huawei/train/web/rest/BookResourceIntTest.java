...
import com.huawei.train.repository.BookRepository;
import com.huawei.train.service.BookService;
...
public class BookResourceIntTest {
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getWriter()).isEqualTo(DEFAULT_WRITER);
    ...
    public void updateBook() throws Exception {
        ...
        assertThat(testBook.getWriter()).isEqualTo(UPDATED_WRITER);
